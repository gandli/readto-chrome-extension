...
- Name: landing.spec.ts >> Readto Landing Page >> Level Slider >> should persist level selection in localStorage
- Location: tests\landing.spec.ts:79:5
...
Call log:
  - waiting for locator('.slider-label:has-text("熟练")')
