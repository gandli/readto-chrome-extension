...
- Name: landing.spec.ts >> Readto Landing Page >> Responsive Design >> should stack content on mobile
- Location: tests\landing.spec.ts:202:5
...
Call log:
  - waiting for locator('section:first-of-type > div')
