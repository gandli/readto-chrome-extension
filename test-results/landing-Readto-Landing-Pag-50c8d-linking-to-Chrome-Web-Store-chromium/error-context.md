...
- Name: landing.spec.ts >> Readto Landing Page >> Page Structure >> should have install button linking to Chrome Web Store
- Location: tests\landing.spec.ts:29:5
...
Locator: locator('a:has-text("安装 Chrome 扩展")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a:has-text("安装 Chrome 扩展")')
