...
- Name: landing.spec.ts >> Readto Landing Page >> How It Works Annotations >> should have ambiguous annotation
- Location: tests\landing.spec.ts:128:5
...
Locator: locator('#how [data-word="ambiguous"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#how [data-word="ambiguous"]')
