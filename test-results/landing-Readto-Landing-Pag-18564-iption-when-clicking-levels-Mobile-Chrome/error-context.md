...
- Name: landing.spec.ts >> Readto Landing Page >> Level Slider >> should update description when clicking levels
- Location: tests\landing.spec.ts:67:5
...
Call log:
  - waiting for locator('.slider-label:has-text("入门")')
