...
- Name: landing.spec.ts >> Readto Landing Page >> Article Preview Annotations >> should have correct annotation words
- Location: tests\landing.spec.ts:100:5
...
Locator: locator('#demo-content [data-word="sweeping"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#demo-content [data-word="sweeping"]')
