...
- Name: landing.spec.ts >> Readto Landing Page >> Accessibility >> annotated words should be keyboard focusable
- Location: tests\landing.spec.ts:254:5
...
Locator: locator('#demo-content [data-readto]').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#demo-content [data-readto]').first()
