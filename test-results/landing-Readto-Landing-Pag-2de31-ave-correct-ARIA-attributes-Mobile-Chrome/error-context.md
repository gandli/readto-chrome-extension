...
- Name: landing.spec.ts >> Readto Landing Page >> Accessibility >> slider should have correct ARIA attributes
- Location: tests\landing.spec.ts:239:5
...
Call log:
  ...
  - waiting for locator('#level-slider')
