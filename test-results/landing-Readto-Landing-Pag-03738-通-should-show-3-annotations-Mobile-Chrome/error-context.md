...
- Name: landing.spec.ts >> Readto Landing Page >> Level-Annotation Linkage >> 精通 should show 3 annotations
- Location: tests\landing.spec.ts:119:5
...
Call log:
  - waiting for locator('.slider-label:has-text("精通")')
    - locator resolved to <span data-index="4" data-astro-source-loc="110:32" class="text-[13px] text-readto-muted-2 slider-label" data-astro-source-file="C:/Users/user/Desktop/readto/readto-website/src/pages/index.astro">精通</span>
